<?php
$filepath = realpath(dirname(__FILE__));            //show the path of this file
...
class Product
{
    ...
    public function insertCompareData($cmprid, $cmrId)
    {
        ...
        if ($result) {
            ...
            $inserted_row = $this->db->insert($query);
            if ($inserted_row) {
                $msg = "<span class='success'>Added. Check your compare page.</span>";
                return $msg;
            } else {
    ...
    public function saveWishListData($id, $cmrId){
        ...
        if ($result) {
                ...
                $inserted_row = $this->db->insert($query);
            if ($inserted_row) {
                $msg = "<span class='success'>Added. Check your wishlist page.</span>";
                return $msg;
            } else {
                $msg = "<span class='error'>Not Added</span>";
                return $msg;
    ...
    public function delWlistData($productId, $cmrId){
        $delquery = "DELETE FROM tbl_wlist WHERE productId = '$productId' AND cmrId = '$cmrId'";
        $deldata = $this->db->delete($delquery);
    }
    ...
    public function searchPd($str){
        // $query = "SELECT * FROM tbl_product WHERE productName LIKE '%$str%'";
        ...
        INNER JOIN tbl_brand 
        ON tbl_product.brandId = tbl_brand.brandId
        WHERE productName LIKE '%$str%' OR brandName LIKE '%$str%' OR catName LIKE '%$str%'
        ORDER By tbl_product.productId 
        DESC";
